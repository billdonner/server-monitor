...
| Change | Action |
|--------|--------|
| cardzerver port changes from 9810 | Update `config/servers.yaml` metrics_endpoint URL |
| Nagzerver port changes from 9800 | Update `config/servers.yaml` metrics_endpoint URL |
| cardzerver adds new `/metrics` fields | No action — new metrics auto-display |
